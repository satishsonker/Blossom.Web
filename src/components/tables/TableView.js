                        ...
                        <div id="example_wrapper" className="dataTables_wrapper dt-bootstrap5">
                            <div className="row">
                                <div className="col-sm-12" style={{ maxHeight: option.maxHeight }}>
                                    <table id="example" className={option?.plainTable?"table table-bordered":"table table-striped table-bordered fixTableHead"} style={{ width: "100%" }} role="grid" aria-describedby="example_info">
